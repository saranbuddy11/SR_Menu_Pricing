Feature: Opel DMS
  ...
  Background:
    * url OPEL_DMS_URL
    * def testSuite = 'uat/Opel_DMS'

  Scenario: 8.0.0 - GetFleets
    Given request read('uat/Opel_DMS/requests/GetFleets.xml')
    When soap action
    Then status 200
...
#    * assert result == true
  ...
  Scenario: 8.0.1 - GetGenericParts
    Given request read('uat/Opel_DMS/requests/GetGenericParts.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.1 - GetGenericParts2
    Given request read('uat/Opel_DMS/requests/GetGenericParts2.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.2 - GetJobAddOns
    Given request read('uat/Opel_DMS/requests/GetJobAddOns.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.3 - GetJobDetails
    Given request read('uat/Opel_DMS/requests/GetJobDetails.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.4 - GetJobDetails_MMRule
    Given request read('uat/Opel_DMS/requests/GetJobDetails_MMRule.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.5 - GetJobDifficulties
    Given request read('uat/Opel_DMS/requests/GetJobDifficulties.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.6 - GetJobs
    Given request read('uat/Opel_DMS/requests/GetJobs.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.7 - GetJobs_POC
    Given request read('uat/Opel_DMS/requests/GetJobs_POC.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.8 - GetJobs_IDFiltered
    Given request read('uat/Opel_DMS/requests/GetJobs_IDFiltered.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.9 - GetJobs_LabourFiltered
    Given request read('uat/Opel_DMS/requests/GetJobs_LabourFiltered.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.10 - GetJobs_PartFiltered
    Given request read('uat/Opel_DMS/requests/GetJobs_PartFiltered.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
    And match response /Envelope/Body/getJobsResponse/jobsResponse/vehicle contains '<vinMatch>W0LPC6E61F8011393</vinMatch>'
  ...
  Scenario: 8.0.11 - GetJobs_DescriptionFiltered
    Given request read('uat/Opel_DMS/requests/GetJobs_DescriptionFiltered.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.12 - GetJobs_PredictedService
    Given request read('uat/Opel_DMS/requests/GetJobs_PredictedService.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.13 - GetVehicleFile
    Given request read('uat/Opel_DMS/requests/GetVehicleFile.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
  ...
  Scenario: 8.0.14 - GetVehicleInfo
    Given request read('uat/Opel_DMS/requests/GetVehicleInfo.xml')
    When soap action
    Then status 200
    And match response /Envelope !contains 'Fault'
