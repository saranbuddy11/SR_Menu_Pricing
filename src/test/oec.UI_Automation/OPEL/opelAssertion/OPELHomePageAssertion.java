...
public class OPELHomePageAssertion extends AbstractAssertion<OPELHomePage> {

    public OPELHomePageAssertion assertAtHomePage() {
        functionalLibrary.waitInSec(5);
        assertThat((functionalLibrary.isAt(functionalLibrary.getBaseURL()))).as("Verify that you are at 'Home' page").isTrue();
        return this;
    }

    public OPELHomePageAssertion assertVehicleDetailsFound() {
        assertThat(functionalLibrary.isVehicleFound()).as("Verify that Vehicle details is present.").isTrue();
        return this;
    }

    public OPELHomePageAssertion assertQuoteSpanIsSelected() {
        assertThat(functionalLibrary.isQuoteSelected()).as("Verify that Quote Span is Selected.").isTrue();
        return this;
    }

    public OPELHomePageAssertion assertJobWorkItemIsDisplayedInQuote() {
        assertThat(functionalLibrary.jobWorkItemInQuote()).as("Verify that 20,000 mls Job work Item added in Quote.").isTrue();
        return this;
    }

    public OPELHomePageAssertion assertCustomerDetailsIsDisplayed(String expectedName, String expectedAddress, String expectedPostCode) {
    ...
    public OPELHomePageAssertion assertSaveBtnIsEnabled() {
        assertThat(functionalLibrary.isSaveBtnEnabled()).as("Verify that Save Button is Enabled.").isTrue();
        return this;
    }

    public OPELHomePageAssertion assertQuoteDetails(String expectedStatus) {
